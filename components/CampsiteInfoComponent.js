...
const mapStateToProps = (state) => {
    return {campsites: state.campsites, comments: state.comments, favorites: state.favorites};
};
    ...
    const panResponder = PanResponder.create({
        ...
        onPanResponderEnd: (e, gestureState) => {
            ...
            if (recognizeDrag(gestureState)) {
                Alert.alert(
                    'Add Favorite',
                    'Are you sure you wish to ad ' + campsite.name + ' to favorite?',
                    [
                        {
                            text: 'Cancel',
                            style: 'cancel',
...
class CampsiteInfo extends Component {
    ...
    render() {
        ...
        const campsite = this
            ...
            .campsites
            .campsites
            .filter((campsite) => campsite.id === campsiteId)[0];
        const comments = this
            .props
            .comments
            .comments
            .filter((comment) => comment.campsiteId === campsiteId);
